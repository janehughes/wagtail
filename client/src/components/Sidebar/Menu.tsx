        ...
        <MainNav collapsed={collapsed} fullyExpanded={fullyExpanded} openFooter={accountSettingsOpen}>
            <ul>
                ...
                <FooterWrapper collapsed={collapsed} isOpen={accountSettingsOpen}>
                    ...
                    <ul>
                        <li><a href={accountUrl} onClick={onClickLink} className="icon icon-user">{'Account settings'}</a></li>{/* GETTEXT */}
                        <li><a href={logoutUrl} onClick={onClickLink} className="icon icon-logout">{'Log out'}</a></li>{/* GETTEXT */}
                    </ul>
                </FooterWrapper>
            </ul>
        </MainNav>
